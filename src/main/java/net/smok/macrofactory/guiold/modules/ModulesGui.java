...
import net.smok.macrofactory.guiold.GuiScreen;
...
public class ModulesGui extends GuiScreen<ModuleWrapper, GuiEntry<ModuleWrapper>> {
    ...
    public ModulesGui(Screen parent) {
        super(10, 25, "guiold.title.screen_module");
        setParent(parent);
    }
    ...
    public void initGui() {
        ...
        addWidget(new WidgetHoverInfo(buttonAdd.getX(), buttonAdd.getY(), buttonAdd.getWidth(), buttonAdd.getHeight(), "guiold.button.module_add"));
        ...
        addWidget(new ConfigButtonKeybind(keybindX, keybindY, keybindWidth, keybindHeight,
                ModulesScreen.SCREEN_OPEN_KEY.getKeybind(), this));
        addWidget(new WidgetHoverInfo(keybindX, keybindY, keybindWidth, keybindHeight, ModulesScreen.SCREEN_OPEN_KEY.getComment()));
